...
echo "num epoch = 200, epoch size = 312, validation batch size = 16"
echo
...
echo "========== START TRAINING =========="
#$PYTHON -u train.py --g 0 --prob_seq setcover_densize_0.075 --data_path data/samples_2.0 
$PYTHON -u train.py \
  --g 0 --data_path data/samples_3.0 --number_of_epochs 200\
  --prob_seq mixed_0.5_0.3_0.4_0.2_0.1_0.1